    ...
    Tables: {
      ...
      access_route_matrices: {
        Row: {
          ...
          id: string
          name: string
          primary_route_multiplier: number | null
          primary_route_table_id: string | null
          rule_id: string | null
          secondary_route_table_id: string | null
          secondary_route_type: string | null
          secondary_route_value: number | null
          updated_at: string
        }
        Insert: {
          created_at?: string
        ...
        Relationships: [
          {
            foreignKeyName: "access_route_matrices_primary_route_table_id_fkey"
            columns: ["primary_route_table_id"]
            isOneToOne: false
            referencedRelation: "reference_tables"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "access_route_matrices_rule_id_fkey"
            columns: ["rule_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "access_route_matrices_secondary_route_table_id_fkey"
            columns: ["secondary_route_table_id"]
            isOneToOne: false
            referencedRelation: "reference_tables"
            referencedColumns: ["id"]
          },
