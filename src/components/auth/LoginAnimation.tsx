    ...
    <div className="w-full h-full flex items-center justify-center relative overflow-hidden">
      <style>{`
        @keyframes rdor-move {
          ...
          75%  { opacity: 0.7; transform: scale(0.72) translateY(-130px); }
          100% { opacity: 0.7; transform: scale(0.72) translateY(-130px); }
        }
        @keyframes line-grow {
        ...
        .rdor-anim {
          animation: rdor-move 8s ease forwards;
          transform-origin: center center;
        }
        .line-anim {
          animation: line-grow 0.6s 5s ease forwards;
          opacity: 0;
          height: 0;
        }
        .exacta-anim {
          animation: exacta-in 0.9s 5.5s cubic-bezier(0.34,1.2,0.64,1) forwards;
          opacity: 0;
        }
      `}</style>
      ...
      <div className="flex flex-col items-center gap-0">
        ...
        {/* Logo Rede D'Or — tamanho maior */}
        <div className="rdor-anim">
          <svg viewBox="0 0 1190.55 300.85" width="300" height="76" aria-label="Rede D'Or">
        ...
        <div
          className="line-anim bg-gradient-to-b from-[rgba(200,169,110,0.6)] to-transparent mx-auto"
          style={{ width: 1 }}
        />

        {/* Bloco Exacta — tamanhos maiores */}
        <div className="exacta-anim flex flex-col items-center gap-3 mt-1">
          <div
            className="flex items-center justify-center rounded-[12px]"
            style={{ width: 50, height: 50, background: '#2D5A4E' }}
          >
          ...
          <p
            ...
            style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: 38, fontWeight: 400, letterSpacing: '0.04em', lineHeight: 1 }}
          >
            E<span style={{ color: '#C8A96E' }}>x</span>acta
          </p>
          <p
            className="text-white/35 uppercase"
            style={{ fontSize: 10, letterSpacing: '0.22em', fontFamily: 'monospace' }}
          >
            Pagamento Médico
          </p>
        </div>
