    ...
    <div className="w-full h-full flex items-center justify-center relative overflow-hidden">
      <style>{`
        @keyframes rdor-move {
          ...
          58%  { opacity: 1; transform: scale(1) translateY(0); }
          78%  { opacity: 0.5; transform: scale(0.48) translateY(-110px); }
          100% { opacity: 0.5; transform: scale(0.48) translateY(-110px); }
        }
        @keyframes line-grow {
        ...
        .rdor-anim {
          animation: rdor-move 5s ease forwards;
          transform-origin: center center;
        }
        .line-anim {
          animation: line-grow 0.5s 3.3s ease forwards;
          opacity: 0;
          height: 0;
        }
        .exacta-anim {
          animation: exacta-in 0.7s 3.7s cubic-bezier(0.34,1.3,0.64,1) forwards;
          opacity: 0;
        }
      `}</style>

      {/* Círculos decorativos de fundo */}
      <div className="absolute top-[-80px] right-[-80px] w-[320px] h-[320px] rounded-full border border-white/[0.04] pointer-events-none" />
      ...
      <div className="flex flex-col items-center gap-0">
        {/* Logo Rede D'Or — anima para cima */}
        <div className="rdor-anim">
          <svg viewBox="0 0 1190.55 300.85" width="220" height="55" aria-label="Rede D'Or">
        ...
        <div
          className="line-anim w-px bg-gradient-to-b from-[rgba(200,169,110,0.5)] to-transparent mx-auto"
          style={{ width: 1 }}
        />

        {/* Bloco Exacta */}
        <div className="exacta-anim flex flex-col items-center gap-2 mt-1">
          <div
            className="flex items-center justify-center rounded-[10px]"
            style={{ width: 40, height: 40, background: '#2D5A4E' }}
          >
            <svg viewBox="0 0 22 22" fill="none" width={22} height={22}>
              <polyline points="3,12 9,18 19,7" stroke="#C8A96E" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
          </div>
          <p
            className="text-white"
            style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: 30, fontWeight: 400, letterSpacing: '0.04em', lineHeight: 1 }}
          >
