...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-auto items-center gap-1 rounded-full border border-border bg-card p-1.5 text-muted-foreground shadow-sm",
      className,
    )}
    {...props}
  />
