  ...
  return (
    ...
    >
      ...
      <Cell
        ...
        extraCls="border-l border-border/70 pl-3"
        corTotal={simCor}
      />
    </div>
  );
            ...
            <CardContent className="px-2 sm:px-6">
              ...
              <div className="overflow-x-auto -mx-2 sm:mx-0">
                ...
                <div className="grid grid-cols-[2rem_1fr_repeat(3,minmax(6rem,1fr))] items-stretch gap-2 pb-2 border-b text-xs font-semibold uppercase tracking-wide text-muted-foreground">
                  ...
                  <span className="text-right text-foreground font-bold border-l border-border/70 pl-3 self-stretch flex items-center justify-end">Simulado</span>
                </div>
                  ...
                  return (
                    <>
                      ...
                      <div className="grid grid-cols-[2rem_1fr_repeat(3,minmax(6rem,1fr))] items-stretch gap-2 text-[10px] text-muted-foreground pl-3">
                        ...
                        <span className="text-right tabular-nums border-l border-border/70 pl-3 self-stretch flex items-center justify-end">{PCT(pctHmSim)}</span>
                      </div>
                      ...
                      <div className="mt-3 pt-3 border-t space-y-1">
                        {(() => {
                          ...
                          return (
                            <div className="grid grid-cols-[2rem_1fr_repeat(3,minmax(6rem,1fr))] items-stretch gap-2 py-2 bg-emerald-50/40 border border-emerald-100 -mx-2 px-2 rounded">
                              ...
                              <div className="text-right flex flex-col justify-center leading-tight border-l border-border/70 pl-3">
                        ...
                        <div className="grid grid-cols-[2rem_1fr_repeat(3,minmax(6rem,1fr))] items-stretch gap-2 text-xs text-muted-foreground">
                          ...
                          <span className="text-right tabular-nums border-l border-border/70 pl-3 font-semibold text-foreground self-stretch flex items-center justify-end">{PCT(pctMargemSimProj)}</span>
                        </div>
...
function SummaryCard({
  ...
  return (
    <Card className={cn("min-w-0 overflow-hidden", highlight && "border-2 border-primary bg-primary/5")}>
      <CardContent className="py-4 px-4 min-w-0">
        <div className={cn("text-[11px] font-medium uppercase tracking-wide truncate", highlight ? "text-primary font-bold" : "text-muted-foreground")}>{title}</div>
        <div className={cn("text-2xl font-semibold tabular-nums mt-1 truncate", highlight ? "text-primary" : cor)}>{BRL(valor)}</div>
        <div className="text-[11px] text-muted-foreground mt-1 leading-snug break-words">
          <div className="truncate">{pct != null ? `${PCT(pct)} da receita líquida` : "—"}</div>
          {extra ? <div className="truncate">{extra}</div> : null}
        </div>
      </CardContent>
    </Card>
  );
