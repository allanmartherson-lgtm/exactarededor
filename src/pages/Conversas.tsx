 ...
 *
 * - Lista todas `company_threads` visíveis ao analista (RLS já filtra por role).
 * - Painel direito: chat da thread selecionada.
 * - Realtime: assina UPDATE/INSERT em `company_threads` para reordenar e
 *   atualizar contadores ao vivo.
 */
...
export default function Conversas() {
  ...
  // Auto-seleciona a primeira thread carregada.
  useEffect(() => {
