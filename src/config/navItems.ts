...
export const NAV_ITEMS: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { to: "/casos-especiais/relatorio", label: "Casos Especiais — Relatório", icon: ShieldCheck, iconName: "ShieldCheck", roles: ["admin", "diretor", "analista", "validador"] as const },
      { to: "/admin/tipos-caso-especial", label: "Tipos de Caso Especial", icon: ShieldCheck, iconName: "ShieldCheck", roles: ["admin", "diretor"] as const },
  ...
  },
  {
    ...
    children: [
      ...
      { to: "/relatorios/auditoria-exportacoes", label: "Auditoria de exportações", icon: History, iconName: "History", roles: ["diretor", "admin", "validador"] },
...
export const EXPECTED_SIDEBAR_ORDER: ReadonlyArray<{ label: string; iconName: string }> = [
  ...
  { label: "Auditoria de exportações", iconName: "History" },
