...
export const NAV_ITEMS: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { to: "/auditoria/totais-lote", label: "Auditoria de totais do lote", icon: Scale, iconName: "Scale", roles: ["diretor", "admin", "validador", "analista"] as const },
...
export const EXPECTED_SIDEBAR_ORDER: ReadonlyArray<{ label: string; iconName: string }> = [
  ...
  { label: "Cadastro de Acordos", iconName: "ClipboardList" },
