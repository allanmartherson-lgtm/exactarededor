...
BEGIN
  ...
  -- Se TODAS as empresas já estão pagas, vai direto para 'pago' (evita
  -- passar por 'lancado' que é bloqueado pela guarda de histórico).
...
-- Destrava o pagamento afetado imediatamente
SELECT public.recompute_payment_status_from_groups('778aacbf-96f5-4b68-9d7e-9fe61d0eb549');
