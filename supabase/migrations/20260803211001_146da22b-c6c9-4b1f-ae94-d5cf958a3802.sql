...
DROP TRIGGER IF EXISTS trg_guard_group_workflow_transition ON public.payment_company_groups;
CREATE TRIGGER trg_guard_group_workflow_transition
BEFORE UPDATE ON public.payment_company_groups
FOR EACH ROW EXECUTE FUNCTION public.guard_group_workflow_transition();