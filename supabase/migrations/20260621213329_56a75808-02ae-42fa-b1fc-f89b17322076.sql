...
BEGIN
  ...
  -- RAISE EXCEPTION em PL/pgSQL só conhece % como placeholder posicional
  -- (não suporta C format-spec tipo %.2f). Por isso pré-formatamos tudo
  -- com to_char e injetamos como string.
