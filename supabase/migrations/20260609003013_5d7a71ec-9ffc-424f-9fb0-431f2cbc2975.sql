ALTER TABLE public.reconciliation_items
  DROP CONSTRAINT IF EXISTS reconciliation_items_action_taken_check;

ALTER TABLE public.reconciliation_items
  ADD CONSTRAINT reconciliation_items_action_taken_check
  CHECK (action_taken IN ('incorporar_credito','incorporar_debito','marcar_glosa','revisar_manual','ignorar','cancelado_conciliacao'));
