...
BEGIN
  ...
  SELECT jsonb_build_object(
    ...
    'waitingValidation', (SELECT count(*) FROM base WHERE status::text = 'aguardando_validacao'),
    'waitingApproval', (SELECT count(*) FROM base WHERE status::text = 'aguardando_aprovacao'),
...
GRANT EXECUTE ON FUNCTION public.payments_kpis(jsonb) TO authenticated, service_role;
