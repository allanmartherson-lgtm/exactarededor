...
BEGIN
  ...
  -- Em modo CONFECÇÃO, payments.status fica em 'rascunho' (placeholder)
  -- e o estado operacional vive em confeccao_status. O trigger
  -- enforce_confeccao_status_coherence proíbe 'revisao_analista' nesse modo.
  v_initial_status := CASE WHEN v_mode = 'confeccao' THEN 'rascunho' ELSE 'revisao_analista' END;
