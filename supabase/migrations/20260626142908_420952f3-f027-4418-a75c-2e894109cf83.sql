...
BEGIN
  ...
  -- Bloqueia a linha do pagamento PRIMEIRO para garantir ordem consistente
  -- de aquisição de locks e evitar deadlock com triggers que reescrevem
  -- payments a partir de payment_company_groups.
  ...
  -- Bloqueia grupos em ordem determinística (por id) para evitar deadlock
  -- com outras transações que tocam os mesmos grupos.
  PERFORM 1
