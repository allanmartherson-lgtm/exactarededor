-- Índice para acelerar filtros por status+payment
CREATE INDEX IF NOT EXISTS idx_caa_payment_status
  ON public.company_adjustment_applications (payment_id, status);
