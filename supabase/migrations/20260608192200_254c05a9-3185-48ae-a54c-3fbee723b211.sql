...
BEGIN
  ...
  -- Cancelamento pertence ao fluxo de pagamento/empresa.
  -- Não consulta tabelas de nota fiscal para não misturar fases do processo.
...
AS $function$
BEGIN
  PERFORM public._assert_can_cancel_group(_group_id);
END;
$function$;
