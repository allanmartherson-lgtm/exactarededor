...
BEGIN
  ...
  INSERT INTO public.payments(id, reference, created_by, hospital_id, import_mode, status)
    VALUES (v_payment_historico, v_ref || '-H', v_user_id, v_hospital_id, 'historico', 'em_analise_ia'),
           (v_payment_normal,    v_ref || '-N', v_user_id, v_hospital_id, 'normal',    'em_analise_ia');
