-- 1) Aceita novos "fonte" no ledger
...
ALTER TABLE public.intervention_ledger
  ...
  CHECK (fonte = ANY (ARRAY[
    ...
    'conciliacao_credito'::text,'conciliacao_debito'::text
  ]));

-- 2) Materialize passa a reconhecer itens criados pela conciliação
