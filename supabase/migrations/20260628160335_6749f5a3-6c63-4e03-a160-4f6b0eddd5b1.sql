...
BEGIN
  ...
  -- Trigger não cria/atualiza grupos a partir do company_id da planilha.
  ...
  v_initial_status := CASE
    ...
    -- Primeira análise: o pagamento acabou de nascer em em_analise_ia e ainda
    -- não há job. O grupo também deve ficar em análise; antes nascia em
    -- revisao_analista, o recompute tirava o lote da fila de watchdog antes
    -- do dispatch e alguns lotes isolados ficavam órfãos sem job.
