...
CREATE OR REPLACE FUNCTION public.get_risk_summary(p_months_back integer DEFAULT 6)
RETURNS TABLE (
  tipo text,
  qtd bigint,
  valor_risco numeric,
  lotes_afetados bigint
...
GRANT EXECUTE ON FUNCTION public.get_risk_summary(integer) TO authenticated;

CREATE OR REPLACE FUNCTION public.get_risk_details(
  p_tipo text,
...
GRANT EXECUTE ON FUNCTION public.get_risk_details(text, integer) TO authenticated;
